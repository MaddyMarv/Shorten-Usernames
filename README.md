...
Standalone mod that fixes massive usernames taking up half your screen. You can set a max character limit for character names and account names. It lets you shorten your own name and your teammates' names. You can pick how it ends, like adding dots or dashes. You can also set it to only work during gameplay so you still see full names in the hub.
